...
namespace Pulumi.Descope
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "https://github.com/descope/pulumi-descope/releases/";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Descope.version.txt");
    ...
    internal sealed class DescopeResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public DescopeResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
