...
namespace Descope.Pulumi.Descope.Outputs
{
    ...
    [OutputType]
    public sealed class ProjectAttributesAccessKey
    {
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.ProjectAttributesAccessKeyWidgetAuthorization? WidgetAuthorization;
        ...
        private ProjectAttributesAccessKey(
            ...
            Outputs.ProjectAttributesAccessKeyWidgetAuthorization? widgetAuthorization)
        {
            Id = id;
            Name = name;
