...
namespace Descope.Pulumi.Descope.Inputs
{
    ...
    public sealed class ProjectAttributesAccessKeyArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Inputs.ProjectAttributesAccessKeyWidgetAuthorizationArgs>? WidgetAuthorization { get; set; }

        public ProjectAttributesAccessKeyArgs()
        {
        }
        public static new ProjectAttributesAccessKeyArgs Empty => new ProjectAttributesAccessKeyArgs();
    }
}
