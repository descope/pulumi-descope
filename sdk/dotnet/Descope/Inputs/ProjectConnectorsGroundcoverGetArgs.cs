...
namespace Descope.Pulumi.Descope.Inputs
{
    ...
    public sealed class ProjectConnectorsGroundcoverGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("auditFilters")]
        private InputList<Inputs.ProjectConnectorsGroundcoverAuditFilterGetArgs>? _auditFilters;

        /// <summary>
        /// Specify which events will be sent to the external audit service (including tenant selection).
        /// </summary>
        public InputList<Inputs.ProjectConnectorsGroundcoverAuditFilterGetArgs> AuditFilters
        {
            get => _auditFilters ?? (_auditFilters = new InputList<Inputs.ProjectConnectorsGroundcoverAuditFilterGetArgs>());
        ...
        public ProjectConnectorsGroundcoverGetArgs()
        {
        }
        public static new ProjectConnectorsGroundcoverGetArgs Empty => new ProjectConnectorsGroundcoverGetArgs();
    }
}
