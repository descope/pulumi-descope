...
namespace Descope.Pulumi.Descope.Inputs
{
    ...
    public sealed class ProjectConnectorsSnowflakeArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("auditFilters")]
        private InputList<Inputs.ProjectConnectorsSnowflakeAuditFilterArgs>? _auditFilters;

        /// <summary>
        /// Specify which events will be sent to the external audit service (including tenant selection).
        /// </summary>
        public InputList<Inputs.ProjectConnectorsSnowflakeAuditFilterArgs> AuditFilters
        {
            get => _auditFilters ?? (_auditFilters = new InputList<Inputs.ProjectConnectorsSnowflakeAuditFilterArgs>());
        ...
        public ProjectConnectorsSnowflakeArgs()
        {
        }
        public static new ProjectConnectorsSnowflakeArgs Empty => new ProjectConnectorsSnowflakeArgs();
    }
}
