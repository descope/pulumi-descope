...
namespace Descope.Pulumi.Descope.Inputs
{
    ...
    public sealed class ProjectConnectorsSplunkGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("auditFilters")]
        private InputList<Inputs.ProjectConnectorsSplunkAuditFilterGetArgs>? _auditFilters;

        /// <summary>
        /// Specify which events will be sent to the external audit service (including tenant selection).
        /// </summary>
        public InputList<Inputs.ProjectConnectorsSplunkAuditFilterGetArgs> AuditFilters
        {
            get => _auditFilters ?? (_auditFilters = new InputList<Inputs.ProjectConnectorsSplunkAuditFilterGetArgs>());
        ...
        public ProjectConnectorsSplunkGetArgs()
        {
        }
        public static new ProjectConnectorsSplunkGetArgs Empty => new ProjectConnectorsSplunkGetArgs();
    }
}
