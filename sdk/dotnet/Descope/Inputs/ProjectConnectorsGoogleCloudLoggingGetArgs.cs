...
namespace Descope.Pulumi.Descope.Inputs
{
    ...
    public sealed class ProjectConnectorsGoogleCloudLoggingGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("auditFilters")]
        private InputList<Inputs.ProjectConnectorsGoogleCloudLoggingAuditFilterGetArgs>? _auditFilters;

        /// <summary>
        /// Specify which events will be sent to the external audit service (including tenant selection).
        /// </summary>
        public InputList<Inputs.ProjectConnectorsGoogleCloudLoggingAuditFilterGetArgs> AuditFilters
        {
            get => _auditFilters ?? (_auditFilters = new InputList<Inputs.ProjectConnectorsGoogleCloudLoggingAuditFilterGetArgs>());
        ...
        public ProjectConnectorsGoogleCloudLoggingGetArgs()
        {
        }
        public static new ProjectConnectorsGoogleCloudLoggingGetArgs Empty => new ProjectConnectorsGoogleCloudLoggingGetArgs();
    }
}
