...
namespace Descope.Pulumi.Descope.Inputs
{
    ...
    public sealed class ProjectConnectorsMixpanelGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("apiSecret")]
        ...
        [Input("auditFilters")]
        private InputList<Inputs.ProjectConnectorsMixpanelAuditFilterGetArgs>? _auditFilters;

        /// <summary>
        /// Specify which events will be sent to the external audit service (including tenant selection).
        /// </summary>
        public InputList<Inputs.ProjectConnectorsMixpanelAuditFilterGetArgs> AuditFilters
        {
            get => _auditFilters ?? (_auditFilters = new InputList<Inputs.ProjectConnectorsMixpanelAuditFilterGetArgs>());
        ...
        public ProjectConnectorsMixpanelGetArgs()
        {
        }
        public static new ProjectConnectorsMixpanelGetArgs Empty => new ProjectConnectorsMixpanelGetArgs();
    }
}
