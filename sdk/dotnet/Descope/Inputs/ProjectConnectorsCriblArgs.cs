...
namespace Descope.Pulumi.Descope.Inputs
{
    ...
    public sealed class ProjectConnectorsCriblArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("auditFilters")]
        private InputList<Inputs.ProjectConnectorsCriblAuditFilterArgs>? _auditFilters;

        /// <summary>
        /// Specify which events will be sent to the external audit service (including tenant selection).
        /// </summary>
        public InputList<Inputs.ProjectConnectorsCriblAuditFilterArgs> AuditFilters
        {
            get => _auditFilters ?? (_auditFilters = new InputList<Inputs.ProjectConnectorsCriblAuditFilterArgs>());
        ...
        public ProjectConnectorsCriblArgs()
        {
        }
        public static new ProjectConnectorsCriblArgs Empty => new ProjectConnectorsCriblArgs();
    }
}
