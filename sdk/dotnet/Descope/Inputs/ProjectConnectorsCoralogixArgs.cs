...
namespace Descope.Pulumi.Descope.Inputs
{
    ...
    public sealed class ProjectConnectorsCoralogixArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("auditFilters")]
        private InputList<Inputs.ProjectConnectorsCoralogixAuditFilterArgs>? _auditFilters;

        /// <summary>
        /// Specify which events will be sent to the external audit service (including tenant selection).
        /// </summary>
        public InputList<Inputs.ProjectConnectorsCoralogixAuditFilterArgs> AuditFilters
        {
            get => _auditFilters ?? (_auditFilters = new InputList<Inputs.ProjectConnectorsCoralogixAuditFilterArgs>());
        ...
        public ProjectConnectorsCoralogixArgs()
        {
        }
        public static new ProjectConnectorsCoralogixArgs Empty => new ProjectConnectorsCoralogixArgs();
    }
}
