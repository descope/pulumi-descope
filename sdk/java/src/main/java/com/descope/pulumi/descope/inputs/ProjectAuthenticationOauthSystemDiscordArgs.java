...
import com.descope.pulumi.descope.inputs.ProjectAuthenticationOauthSystemDiscordAppleKeyGeneratorArgs;
import com.descope.pulumi.descope.inputs.ProjectAuthenticationOauthSystemDiscordNativeAppleKeyGeneratorArgs;
import com.descope.pulumi.descope.inputs.ProjectAuthenticationOauthSystemDiscordProviderTokenManagementArgs;
...
public final class ProjectAuthenticationOauthSystemDiscordArgs extends com.pulumi.resources.ResourceArgs {

    public static final ProjectAuthenticationOauthSystemDiscordArgs Empty = new ProjectAuthenticationOauthSystemDiscordArgs();
    ...
    private @Nullable Output<ProjectAuthenticationOauthSystemDiscordAppleKeyGeneratorArgs> appleKeyGenerator;

    /**
     * @return The apple key generator object describing how to create a dynamic apple client secret for applications.
     * 
     */
    public Optional<Output<ProjectAuthenticationOauthSystemDiscordAppleKeyGeneratorArgs>> appleKeyGenerator() {
    ...
    private @Nullable Output<ProjectAuthenticationOauthSystemDiscordNativeAppleKeyGeneratorArgs> nativeAppleKeyGenerator;

    /**
     * @return The apple key generator object describing how to create a dynamic naive apple client secret for mobile apps.
     * 
     */
    public Optional<Output<ProjectAuthenticationOauthSystemDiscordNativeAppleKeyGeneratorArgs>> nativeAppleKeyGenerator() {
    ...
    private ProjectAuthenticationOauthSystemDiscordArgs() {}
    ...
    public static Builder builder(ProjectAuthenticationOauthSystemDiscordArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ProjectAuthenticationOauthSystemDiscordArgs();
        }

        public Builder(ProjectAuthenticationOauthSystemDiscordArgs defaults) {
            $ = new ProjectAuthenticationOauthSystemDiscordArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder appleKeyGenerator(@Nullable Output<ProjectAuthenticationOauthSystemDiscordAppleKeyGeneratorArgs> appleKeyGenerator) {
         ...
         * 
         */
        public Builder appleKeyGenerator(ProjectAuthenticationOauthSystemDiscordAppleKeyGeneratorArgs appleKeyGenerator) {
         ...
         * 
         */
        public Builder nativeAppleKeyGenerator(@Nullable Output<ProjectAuthenticationOauthSystemDiscordNativeAppleKeyGeneratorArgs> nativeAppleKeyGenerator) {
         ...
         * 
         */
        public Builder nativeAppleKeyGenerator(ProjectAuthenticationOauthSystemDiscordNativeAppleKeyGeneratorArgs nativeAppleKeyGenerator) {
         ...
         * 
         */
        public Builder providerTokenManagement(@Nullable Output<ProjectAuthenticationOauthSystemDiscordProviderTokenManagementArgs> providerTokenManagement) {
        ...
        public ProjectAuthenticationOauthSystemDiscordArgs build() {
            return $;
        }
    }
