...
import com.descope.pulumi.descope.inputs.ProjectAuthenticationOauthSystemFacebookAppleKeyGeneratorArgs;
import com.descope.pulumi.descope.inputs.ProjectAuthenticationOauthSystemFacebookNativeAppleKeyGeneratorArgs;
import com.descope.pulumi.descope.inputs.ProjectAuthenticationOauthSystemFacebookProviderTokenManagementArgs;
...
public final class ProjectAuthenticationOauthSystemFacebookArgs extends com.pulumi.resources.ResourceArgs {

    public static final ProjectAuthenticationOauthSystemFacebookArgs Empty = new ProjectAuthenticationOauthSystemFacebookArgs();
    ...
    private @Nullable Output<ProjectAuthenticationOauthSystemFacebookAppleKeyGeneratorArgs> appleKeyGenerator;

    /**
     * @return The apple key generator object describing how to create a dynamic apple client secret for applications.
     * 
     */
    public Optional<Output<ProjectAuthenticationOauthSystemFacebookAppleKeyGeneratorArgs>> appleKeyGenerator() {
    ...
    private @Nullable Output<ProjectAuthenticationOauthSystemFacebookNativeAppleKeyGeneratorArgs> nativeAppleKeyGenerator;

    /**
     * @return The apple key generator object describing how to create a dynamic naive apple client secret for mobile apps.
     * 
     */
    public Optional<Output<ProjectAuthenticationOauthSystemFacebookNativeAppleKeyGeneratorArgs>> nativeAppleKeyGenerator() {
    ...
    private @Nullable Output<ProjectAuthenticationOauthSystemFacebookProviderTokenManagementArgs> providerTokenManagement;

    /**
     * @return This attribute is deprecated, use the `manageProviderTokens`, `callbackDomain`, and `redirectUrl` fields instead.
     * 
     */
    public Optional<Output<ProjectAuthenticationOauthSystemFacebookProviderTokenManagementArgs>> providerTokenManagement() {
    ...
    private ProjectAuthenticationOauthSystemFacebookArgs() {}

    private ProjectAuthenticationOauthSystemFacebookArgs(ProjectAuthenticationOauthSystemFacebookArgs $) {
    ...
    public static Builder builder(ProjectAuthenticationOauthSystemFacebookArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ProjectAuthenticationOauthSystemFacebookArgs();
        }

        public Builder(ProjectAuthenticationOauthSystemFacebookArgs defaults) {
            $ = new ProjectAuthenticationOauthSystemFacebookArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder appleKeyGenerator(@Nullable Output<ProjectAuthenticationOauthSystemFacebookAppleKeyGeneratorArgs> appleKeyGenerator) {
         ...
         * 
         */
        public Builder appleKeyGenerator(ProjectAuthenticationOauthSystemFacebookAppleKeyGeneratorArgs appleKeyGenerator) {
         ...
         * 
         */
        public Builder nativeAppleKeyGenerator(@Nullable Output<ProjectAuthenticationOauthSystemFacebookNativeAppleKeyGeneratorArgs> nativeAppleKeyGenerator) {
         ...
         * 
         */
        public Builder nativeAppleKeyGenerator(ProjectAuthenticationOauthSystemFacebookNativeAppleKeyGeneratorArgs nativeAppleKeyGenerator) {
         ...
         * 
         */
        public Builder providerTokenManagement(@Nullable Output<ProjectAuthenticationOauthSystemFacebookProviderTokenManagementArgs> providerTokenManagement) {
         ...
         * 
         */
        public Builder providerTokenManagement(ProjectAuthenticationOauthSystemFacebookProviderTokenManagementArgs providerTokenManagement) {
        ...
        public ProjectAuthenticationOauthSystemFacebookArgs build() {
            return $;
        }
    }
