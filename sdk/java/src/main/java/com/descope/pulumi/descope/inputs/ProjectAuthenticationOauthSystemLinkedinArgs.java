...
import com.descope.pulumi.descope.inputs.ProjectAuthenticationOauthSystemLinkedinAppleKeyGeneratorArgs;
import com.descope.pulumi.descope.inputs.ProjectAuthenticationOauthSystemLinkedinNativeAppleKeyGeneratorArgs;
import com.descope.pulumi.descope.inputs.ProjectAuthenticationOauthSystemLinkedinProviderTokenManagementArgs;
...
public final class ProjectAuthenticationOauthSystemLinkedinArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<ProjectAuthenticationOauthSystemLinkedinAppleKeyGeneratorArgs> appleKeyGenerator;

    /**
     * @return The apple key generator object describing how to create a dynamic apple client secret for applications.
     * 
     */
    public Optional<Output<ProjectAuthenticationOauthSystemLinkedinAppleKeyGeneratorArgs>> appleKeyGenerator() {
    ...
    private @Nullable Output<ProjectAuthenticationOauthSystemLinkedinNativeAppleKeyGeneratorArgs> nativeAppleKeyGenerator;

    /**
     * @return The apple key generator object describing how to create a dynamic naive apple client secret for mobile apps.
     * 
     */
    public Optional<Output<ProjectAuthenticationOauthSystemLinkedinNativeAppleKeyGeneratorArgs>> nativeAppleKeyGenerator() {
    ...
    private ProjectAuthenticationOauthSystemLinkedinArgs() {}

    private ProjectAuthenticationOauthSystemLinkedinArgs(ProjectAuthenticationOauthSystemLinkedinArgs $) {
    ...
    public static Builder builder(ProjectAuthenticationOauthSystemLinkedinArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ProjectAuthenticationOauthSystemLinkedinArgs();
        }

        public Builder(ProjectAuthenticationOauthSystemLinkedinArgs defaults) {
            $ = new ProjectAuthenticationOauthSystemLinkedinArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder appleKeyGenerator(@Nullable Output<ProjectAuthenticationOauthSystemLinkedinAppleKeyGeneratorArgs> appleKeyGenerator) {
         ...
         * 
         */
        public Builder appleKeyGenerator(ProjectAuthenticationOauthSystemLinkedinAppleKeyGeneratorArgs appleKeyGenerator) {
         ...
         * 
         */
        public Builder nativeAppleKeyGenerator(@Nullable Output<ProjectAuthenticationOauthSystemLinkedinNativeAppleKeyGeneratorArgs> nativeAppleKeyGenerator) {
         ...
         * 
         */
        public Builder nativeAppleKeyGenerator(ProjectAuthenticationOauthSystemLinkedinNativeAppleKeyGeneratorArgs nativeAppleKeyGenerator) {
         ...
         * 
         */
        public Builder providerTokenManagement(@Nullable Output<ProjectAuthenticationOauthSystemLinkedinProviderTokenManagementArgs> providerTokenManagement) {
         ...
         * 
         */
        public Builder providerTokenManagement(ProjectAuthenticationOauthSystemLinkedinProviderTokenManagementArgs providerTokenManagement) {
        ...
        public ProjectAuthenticationOauthSystemLinkedinArgs build() {
            return $;
        }
    }
