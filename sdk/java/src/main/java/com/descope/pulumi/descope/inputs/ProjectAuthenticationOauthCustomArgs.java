...
import com.descope.pulumi.descope.inputs.ProjectAuthenticationOauthCustomAppleKeyGeneratorArgs;
import com.descope.pulumi.descope.inputs.ProjectAuthenticationOauthCustomNativeAppleKeyGeneratorArgs;
import com.descope.pulumi.descope.inputs.ProjectAuthenticationOauthCustomProviderTokenManagementArgs;
...
public final class ProjectAuthenticationOauthCustomArgs extends com.pulumi.resources.ResourceArgs {

    public static final ProjectAuthenticationOauthCustomArgs Empty = new ProjectAuthenticationOauthCustomArgs();
    ...
    private @Nullable Output<ProjectAuthenticationOauthCustomAppleKeyGeneratorArgs> appleKeyGenerator;

    /**
     * @return The apple key generator object describing how to create a dynamic apple client secret for applications.
     * 
     */
    public Optional<Output<ProjectAuthenticationOauthCustomAppleKeyGeneratorArgs>> appleKeyGenerator() {
    ...
    private @Nullable Output<ProjectAuthenticationOauthCustomNativeAppleKeyGeneratorArgs> nativeAppleKeyGenerator;

    /**
     * @return The apple key generator object describing how to create a dynamic naive apple client secret for mobile apps.
     * 
     */
    public Optional<Output<ProjectAuthenticationOauthCustomNativeAppleKeyGeneratorArgs>> nativeAppleKeyGenerator() {
    ...
    private @Nullable Output<ProjectAuthenticationOauthCustomProviderTokenManagementArgs> providerTokenManagement;

    /**
     * @return This attribute is deprecated, use the `manageProviderTokens`, `callbackDomain`, and `redirectUrl` fields instead.
     * 
     */
    public Optional<Output<ProjectAuthenticationOauthCustomProviderTokenManagementArgs>> providerTokenManagement() {
    ...
    private ProjectAuthenticationOauthCustomArgs() {}

    private ProjectAuthenticationOauthCustomArgs(ProjectAuthenticationOauthCustomArgs $) {
    ...
    public static Builder builder(ProjectAuthenticationOauthCustomArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ProjectAuthenticationOauthCustomArgs();
        }

        public Builder(ProjectAuthenticationOauthCustomArgs defaults) {
            $ = new ProjectAuthenticationOauthCustomArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder appleKeyGenerator(@Nullable Output<ProjectAuthenticationOauthCustomAppleKeyGeneratorArgs> appleKeyGenerator) {
         ...
         * 
         */
        public Builder appleKeyGenerator(ProjectAuthenticationOauthCustomAppleKeyGeneratorArgs appleKeyGenerator) {
         ...
         * 
         */
        public Builder nativeAppleKeyGenerator(@Nullable Output<ProjectAuthenticationOauthCustomNativeAppleKeyGeneratorArgs> nativeAppleKeyGenerator) {
         ...
         * 
         */
        public Builder nativeAppleKeyGenerator(ProjectAuthenticationOauthCustomNativeAppleKeyGeneratorArgs nativeAppleKeyGenerator) {
         ...
         * 
         */
        public Builder providerTokenManagement(@Nullable Output<ProjectAuthenticationOauthCustomProviderTokenManagementArgs> providerTokenManagement) {
         ...
         * 
         */
        public Builder providerTokenManagement(ProjectAuthenticationOauthCustomProviderTokenManagementArgs providerTokenManagement) {
        ...
        public ProjectAuthenticationOauthCustomArgs build() {
            return $;
        }
    }
