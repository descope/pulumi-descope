...
import com.descope.pulumi.descope.outputs.ProjectConnectorsCoralogixAuditFilter;
...
@CustomType
public final class ProjectConnectorsCoralogix {
    /**
     ...
     * 
     */
    private @Nullable List<ProjectConnectorsCoralogixAuditFilter> auditFilters;
    /**
     ...
     * 
     */
    public List<ProjectConnectorsCoralogixAuditFilter> auditFilters() {
    ...
    public static Builder builder(ProjectConnectorsCoralogix defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean troubleshootLogEnabled;
        public Builder() {}
        public Builder(ProjectConnectorsCoralogix defaults) {
        ...
        @CustomType.Setter
        public Builder auditFilters(@Nullable List<ProjectConnectorsCoralogixAuditFilter> auditFilters) {

            this.auditFilters = auditFilters;
            return this;
        }
        public Builder auditFilters(ProjectConnectorsCoralogixAuditFilter... auditFilters) {
            return auditFilters(List.of(auditFilters));
        }
        @CustomType.Setter
        public Builder bearerToken(String bearerToken) {
            if (bearerToken == null) {
              throw new MissingRequiredPropertyException("ProjectConnectorsCoralogix", "bearerToken");
            }
        ...
        public Builder endpoint(String endpoint) {
            if (endpoint == null) {
              throw new MissingRequiredPropertyException("ProjectConnectorsCoralogix", "endpoint");
            }
        ...
        public ProjectConnectorsCoralogix build() {
            final var _resultValue = new ProjectConnectorsCoralogix();
