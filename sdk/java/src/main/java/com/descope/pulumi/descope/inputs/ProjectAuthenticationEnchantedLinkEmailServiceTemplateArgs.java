...
public final class ProjectAuthenticationEnchantedLinkEmailServiceTemplateArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private ProjectAuthenticationEnchantedLinkEmailServiceTemplateArgs() {}

    private ProjectAuthenticationEnchantedLinkEmailServiceTemplateArgs(ProjectAuthenticationEnchantedLinkEmailServiceTemplateArgs $) {
        this.active = $.active;
    ...
    public static Builder builder(ProjectAuthenticationEnchantedLinkEmailServiceTemplateArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ProjectAuthenticationEnchantedLinkEmailServiceTemplateArgs();
        }

        public Builder(ProjectAuthenticationEnchantedLinkEmailServiceTemplateArgs defaults) {
        ...
        public ProjectAuthenticationEnchantedLinkEmailServiceTemplateArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("ProjectAuthenticationEnchantedLinkEmailServiceTemplateArgs", "name");
            }
            if ($.subject == null) {
                throw new MissingRequiredPropertyException("ProjectAuthenticationEnchantedLinkEmailServiceTemplateArgs", "subject");
            }
            return $;
        }
    }
