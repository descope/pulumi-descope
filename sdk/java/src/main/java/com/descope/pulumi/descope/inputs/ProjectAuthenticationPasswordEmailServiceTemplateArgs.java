...
public final class ProjectAuthenticationPasswordEmailServiceTemplateArgs extends com.pulumi.resources.ResourceArgs {

    public static final ProjectAuthenticationPasswordEmailServiceTemplateArgs Empty = new ProjectAuthenticationPasswordEmailServiceTemplateArgs();
    ...
    private ProjectAuthenticationPasswordEmailServiceTemplateArgs() {}

    private ProjectAuthenticationPasswordEmailServiceTemplateArgs(ProjectAuthenticationPasswordEmailServiceTemplateArgs $) {
        this.active = $.active;
    ...
    public static Builder builder(ProjectAuthenticationPasswordEmailServiceTemplateArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ProjectAuthenticationPasswordEmailServiceTemplateArgs();
        }

        public Builder(ProjectAuthenticationPasswordEmailServiceTemplateArgs defaults) {
            $ = new ProjectAuthenticationPasswordEmailServiceTemplateArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ProjectAuthenticationPasswordEmailServiceTemplateArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("ProjectAuthenticationPasswordEmailServiceTemplateArgs", "name");
            }
            if ($.subject == null) {
                throw new MissingRequiredPropertyException("ProjectAuthenticationPasswordEmailServiceTemplateArgs", "subject");
            }
            return $;
        }
    }
