...
public final class ProjectAuthenticationSsoEmailServiceTemplateArgs extends com.pulumi.resources.ResourceArgs {

    public static final ProjectAuthenticationSsoEmailServiceTemplateArgs Empty = new ProjectAuthenticationSsoEmailServiceTemplateArgs();
    ...
    private ProjectAuthenticationSsoEmailServiceTemplateArgs() {}

    private ProjectAuthenticationSsoEmailServiceTemplateArgs(ProjectAuthenticationSsoEmailServiceTemplateArgs $) {
        this.active = $.active;
    ...
    public static Builder builder(ProjectAuthenticationSsoEmailServiceTemplateArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ProjectAuthenticationSsoEmailServiceTemplateArgs();
        }

        public Builder(ProjectAuthenticationSsoEmailServiceTemplateArgs defaults) {
            $ = new ProjectAuthenticationSsoEmailServiceTemplateArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ProjectAuthenticationSsoEmailServiceTemplateArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("ProjectAuthenticationSsoEmailServiceTemplateArgs", "name");
            }
            if ($.subject == null) {
                throw new MissingRequiredPropertyException("ProjectAuthenticationSsoEmailServiceTemplateArgs", "subject");
            }
            return $;
        }
    }
