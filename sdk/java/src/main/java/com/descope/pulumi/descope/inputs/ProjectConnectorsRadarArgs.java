...
public final class ProjectConnectorsRadarArgs extends com.pulumi.resources.ResourceArgs {

    public static final ProjectConnectorsRadarArgs Empty = new ProjectConnectorsRadarArgs();
    ...
    private ProjectConnectorsRadarArgs() {}

    private ProjectConnectorsRadarArgs(ProjectConnectorsRadarArgs $) {
    ...
    public static Builder builder(ProjectConnectorsRadarArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ProjectConnectorsRadarArgs();
        }

        public Builder(ProjectConnectorsRadarArgs defaults) {
            $ = new ProjectConnectorsRadarArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param publicApiKey The Radar publishable API key.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param region The region code, specified as a two-letter ISO 3166 code.
         * 
         * @return builder
         * 
         */
        ...
        public ProjectConnectorsRadarArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("ProjectConnectorsRadarArgs", "name");
            }
            if ($.publicApiKey == null) {
                throw new MissingRequiredPropertyException("ProjectConnectorsRadarArgs", "publicApiKey");
            }
            return $;
        }
    }
