...
@CustomType
public final class ProjectInviteSettingsEmailServiceTemplate {
    /**
    ...
    private ProjectInviteSettingsEmailServiceTemplate() {}
    /**
     * @return Whether this email template is currently active and in use.
     * 
     */
    ...
    public static Builder builder(ProjectInviteSettingsEmailServiceTemplate defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean usePlainTextBody;
        public Builder() {}
        public Builder(ProjectInviteSettingsEmailServiceTemplate defaults) {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("ProjectInviteSettingsEmailServiceTemplate", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder subject(String subject) {
            if (subject == null) {
              throw new MissingRequiredPropertyException("ProjectInviteSettingsEmailServiceTemplate", "subject");
            }
        ...
        public ProjectInviteSettingsEmailServiceTemplate build() {
            final var _resultValue = new ProjectInviteSettingsEmailServiceTemplate();
