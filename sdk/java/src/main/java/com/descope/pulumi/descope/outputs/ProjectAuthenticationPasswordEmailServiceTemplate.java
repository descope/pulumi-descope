...
@CustomType
public final class ProjectAuthenticationPasswordEmailServiceTemplate {
    /**
    ...
    private ProjectAuthenticationPasswordEmailServiceTemplate() {}
    /**
     * @return Whether this email template is currently active and in use.
     * 
     */
    ...
    public static Builder builder(ProjectAuthenticationPasswordEmailServiceTemplate defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean usePlainTextBody;
        public Builder() {}
        public Builder(ProjectAuthenticationPasswordEmailServiceTemplate defaults) {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("ProjectAuthenticationPasswordEmailServiceTemplate", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder subject(String subject) {
            if (subject == null) {
              throw new MissingRequiredPropertyException("ProjectAuthenticationPasswordEmailServiceTemplate", "subject");
            }
        ...
        public ProjectAuthenticationPasswordEmailServiceTemplate build() {
            final var _resultValue = new ProjectAuthenticationPasswordEmailServiceTemplate();
