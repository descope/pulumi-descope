...
import com.descope.pulumi.descope.inputs.ProjectAuthenticationOauthSystemGitlabAppleKeyGeneratorArgs;
import com.descope.pulumi.descope.inputs.ProjectAuthenticationOauthSystemGitlabNativeAppleKeyGeneratorArgs;
import com.descope.pulumi.descope.inputs.ProjectAuthenticationOauthSystemGitlabProviderTokenManagementArgs;
...
public final class ProjectAuthenticationOauthSystemGitlabArgs extends com.pulumi.resources.ResourceArgs {

    public static final ProjectAuthenticationOauthSystemGitlabArgs Empty = new ProjectAuthenticationOauthSystemGitlabArgs();
    ...
    private @Nullable Output<ProjectAuthenticationOauthSystemGitlabAppleKeyGeneratorArgs> appleKeyGenerator;

    /**
     * @return The apple key generator object describing how to create a dynamic apple client secret for applications.
     * 
     */
    public Optional<Output<ProjectAuthenticationOauthSystemGitlabAppleKeyGeneratorArgs>> appleKeyGenerator() {
    ...
    private @Nullable Output<ProjectAuthenticationOauthSystemGitlabNativeAppleKeyGeneratorArgs> nativeAppleKeyGenerator;

    /**
     * @return The apple key generator object describing how to create a dynamic naive apple client secret for mobile apps.
     * 
     */
    public Optional<Output<ProjectAuthenticationOauthSystemGitlabNativeAppleKeyGeneratorArgs>> nativeAppleKeyGenerator() {
    ...
    private @Nullable Output<ProjectAuthenticationOauthSystemGitlabProviderTokenManagementArgs> providerTokenManagement;

    /**
     * @return This attribute is deprecated, use the `manageProviderTokens`, `callbackDomain`, and `redirectUrl` fields instead.
     * 
     */
    public Optional<Output<ProjectAuthenticationOauthSystemGitlabProviderTokenManagementArgs>> providerTokenManagement() {
    ...
    private ProjectAuthenticationOauthSystemGitlabArgs() {}

    private ProjectAuthenticationOauthSystemGitlabArgs(ProjectAuthenticationOauthSystemGitlabArgs $) {
    ...
    public static Builder builder(ProjectAuthenticationOauthSystemGitlabArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ProjectAuthenticationOauthSystemGitlabArgs();
        }

        public Builder(ProjectAuthenticationOauthSystemGitlabArgs defaults) {
            $ = new ProjectAuthenticationOauthSystemGitlabArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder appleKeyGenerator(@Nullable Output<ProjectAuthenticationOauthSystemGitlabAppleKeyGeneratorArgs> appleKeyGenerator) {
         ...
         * 
         */
        public Builder appleKeyGenerator(ProjectAuthenticationOauthSystemGitlabAppleKeyGeneratorArgs appleKeyGenerator) {
         ...
         * 
         */
        public Builder nativeAppleKeyGenerator(@Nullable Output<ProjectAuthenticationOauthSystemGitlabNativeAppleKeyGeneratorArgs> nativeAppleKeyGenerator) {
         ...
         * 
         */
        public Builder nativeAppleKeyGenerator(ProjectAuthenticationOauthSystemGitlabNativeAppleKeyGeneratorArgs nativeAppleKeyGenerator) {
         ...
         * 
         */
        public Builder providerTokenManagement(@Nullable Output<ProjectAuthenticationOauthSystemGitlabProviderTokenManagementArgs> providerTokenManagement) {
         ...
         * 
         */
        public Builder providerTokenManagement(ProjectAuthenticationOauthSystemGitlabProviderTokenManagementArgs providerTokenManagement) {
        ...
        public ProjectAuthenticationOauthSystemGitlabArgs build() {
            return $;
        }
    }
