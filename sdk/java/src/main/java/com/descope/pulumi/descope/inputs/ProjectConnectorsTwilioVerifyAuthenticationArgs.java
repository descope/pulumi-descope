...
public final class ProjectConnectorsTwilioVerifyAuthenticationArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private ProjectConnectorsTwilioVerifyAuthenticationArgs() {}

    private ProjectConnectorsTwilioVerifyAuthenticationArgs(ProjectConnectorsTwilioVerifyAuthenticationArgs $) {
        this.apiKey = $.apiKey;
    ...
    public static Builder builder(ProjectConnectorsTwilioVerifyAuthenticationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ProjectConnectorsTwilioVerifyAuthenticationArgs();
        }

        public Builder(ProjectConnectorsTwilioVerifyAuthenticationArgs defaults) {
        ...
        public ProjectConnectorsTwilioVerifyAuthenticationArgs build() {
            return $;
        }
    }
