...
import com.descope.pulumi.descope.inputs.ProjectAuthenticationOauthSystemGithubAppleKeyGeneratorArgs;
import com.descope.pulumi.descope.inputs.ProjectAuthenticationOauthSystemGithubNativeAppleKeyGeneratorArgs;
...
public final class ProjectAuthenticationOauthSystemGithubArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<ProjectAuthenticationOauthSystemGithubAppleKeyGeneratorArgs> appleKeyGenerator;

    /**
     * @return The apple key generator object describing how to create a dynamic apple client secret for applications.
     * 
     */
    public Optional<Output<ProjectAuthenticationOauthSystemGithubAppleKeyGeneratorArgs>> appleKeyGenerator() {
    ...
    private @Nullable Output<ProjectAuthenticationOauthSystemGithubNativeAppleKeyGeneratorArgs> nativeAppleKeyGenerator;

    /**
     * @return The apple key generator object describing how to create a dynamic naive apple client secret for mobile apps.
     * 
     */
    public Optional<Output<ProjectAuthenticationOauthSystemGithubNativeAppleKeyGeneratorArgs>> nativeAppleKeyGenerator() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder appleKeyGenerator(@Nullable Output<ProjectAuthenticationOauthSystemGithubAppleKeyGeneratorArgs> appleKeyGenerator) {
         ...
         * 
         */
        public Builder appleKeyGenerator(ProjectAuthenticationOauthSystemGithubAppleKeyGeneratorArgs appleKeyGenerator) {
         ...
         * 
         */
        public Builder nativeAppleKeyGenerator(@Nullable Output<ProjectAuthenticationOauthSystemGithubNativeAppleKeyGeneratorArgs> nativeAppleKeyGenerator) {
         ...
         * 
         */
        public Builder nativeAppleKeyGenerator(ProjectAuthenticationOauthSystemGithubNativeAppleKeyGeneratorArgs nativeAppleKeyGenerator) {
