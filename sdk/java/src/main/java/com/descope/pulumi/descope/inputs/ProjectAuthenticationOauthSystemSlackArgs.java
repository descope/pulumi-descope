...
import com.descope.pulumi.descope.inputs.ProjectAuthenticationOauthSystemSlackAppleKeyGeneratorArgs;
import com.descope.pulumi.descope.inputs.ProjectAuthenticationOauthSystemSlackNativeAppleKeyGeneratorArgs;
import com.descope.pulumi.descope.inputs.ProjectAuthenticationOauthSystemSlackProviderTokenManagementArgs;
...
public final class ProjectAuthenticationOauthSystemSlackArgs extends com.pulumi.resources.ResourceArgs {

    public static final ProjectAuthenticationOauthSystemSlackArgs Empty = new ProjectAuthenticationOauthSystemSlackArgs();
    ...
    private @Nullable Output<ProjectAuthenticationOauthSystemSlackAppleKeyGeneratorArgs> appleKeyGenerator;

    /**
     * @return The apple key generator object describing how to create a dynamic apple client secret for applications.
     * 
     */
    public Optional<Output<ProjectAuthenticationOauthSystemSlackAppleKeyGeneratorArgs>> appleKeyGenerator() {
    ...
    private @Nullable Output<ProjectAuthenticationOauthSystemSlackNativeAppleKeyGeneratorArgs> nativeAppleKeyGenerator;

    /**
     * @return The apple key generator object describing how to create a dynamic naive apple client secret for mobile apps.
     * 
     */
    public Optional<Output<ProjectAuthenticationOauthSystemSlackNativeAppleKeyGeneratorArgs>> nativeAppleKeyGenerator() {
    ...
    private @Nullable Output<ProjectAuthenticationOauthSystemSlackProviderTokenManagementArgs> providerTokenManagement;

    /**
     * @return This attribute is deprecated, use the `manageProviderTokens`, `callbackDomain`, and `redirectUrl` fields instead.
     * 
     */
    public Optional<Output<ProjectAuthenticationOauthSystemSlackProviderTokenManagementArgs>> providerTokenManagement() {
    ...
    private ProjectAuthenticationOauthSystemSlackArgs() {}

    private ProjectAuthenticationOauthSystemSlackArgs(ProjectAuthenticationOauthSystemSlackArgs $) {
    ...
    public static Builder builder(ProjectAuthenticationOauthSystemSlackArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ProjectAuthenticationOauthSystemSlackArgs();
        }

        public Builder(ProjectAuthenticationOauthSystemSlackArgs defaults) {
            $ = new ProjectAuthenticationOauthSystemSlackArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder appleKeyGenerator(@Nullable Output<ProjectAuthenticationOauthSystemSlackAppleKeyGeneratorArgs> appleKeyGenerator) {
         ...
         * 
         */
        public Builder appleKeyGenerator(ProjectAuthenticationOauthSystemSlackAppleKeyGeneratorArgs appleKeyGenerator) {
         ...
         * 
         */
        public Builder nativeAppleKeyGenerator(@Nullable Output<ProjectAuthenticationOauthSystemSlackNativeAppleKeyGeneratorArgs> nativeAppleKeyGenerator) {
         ...
         * 
         */
        public Builder nativeAppleKeyGenerator(ProjectAuthenticationOauthSystemSlackNativeAppleKeyGeneratorArgs nativeAppleKeyGenerator) {
         ...
         * 
         */
        public Builder providerTokenManagement(@Nullable Output<ProjectAuthenticationOauthSystemSlackProviderTokenManagementArgs> providerTokenManagement) {
         ...
         * 
         */
        public Builder providerTokenManagement(ProjectAuthenticationOauthSystemSlackProviderTokenManagementArgs providerTokenManagement) {
        ...
        public ProjectAuthenticationOauthSystemSlackArgs build() {
            return $;
        }
    }
