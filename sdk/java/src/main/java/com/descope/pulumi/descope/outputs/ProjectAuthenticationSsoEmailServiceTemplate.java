...
@CustomType
public final class ProjectAuthenticationSsoEmailServiceTemplate {
    /**
    ...
    private ProjectAuthenticationSsoEmailServiceTemplate() {}
    /**
     * @return Whether this email template is currently active and in use.
     * 
     */
    ...
    public static Builder builder(ProjectAuthenticationSsoEmailServiceTemplate defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean usePlainTextBody;
        public Builder() {}
        public Builder(ProjectAuthenticationSsoEmailServiceTemplate defaults) {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("ProjectAuthenticationSsoEmailServiceTemplate", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder subject(String subject) {
            if (subject == null) {
              throw new MissingRequiredPropertyException("ProjectAuthenticationSsoEmailServiceTemplate", "subject");
            }
        ...
        public ProjectAuthenticationSsoEmailServiceTemplate build() {
            final var _resultValue = new ProjectAuthenticationSsoEmailServiceTemplate();
