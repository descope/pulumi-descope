...
public final class ProjectAuthenticationOtpEmailServiceTemplateArgs extends com.pulumi.resources.ResourceArgs {

    public static final ProjectAuthenticationOtpEmailServiceTemplateArgs Empty = new ProjectAuthenticationOtpEmailServiceTemplateArgs();
    ...
    private ProjectAuthenticationOtpEmailServiceTemplateArgs() {}

    private ProjectAuthenticationOtpEmailServiceTemplateArgs(ProjectAuthenticationOtpEmailServiceTemplateArgs $) {
        this.active = $.active;
    ...
    public static Builder builder(ProjectAuthenticationOtpEmailServiceTemplateArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ProjectAuthenticationOtpEmailServiceTemplateArgs();
        }

        public Builder(ProjectAuthenticationOtpEmailServiceTemplateArgs defaults) {
            $ = new ProjectAuthenticationOtpEmailServiceTemplateArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ProjectAuthenticationOtpEmailServiceTemplateArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("ProjectAuthenticationOtpEmailServiceTemplateArgs", "name");
            }
            if ($.subject == null) {
                throw new MissingRequiredPropertyException("ProjectAuthenticationOtpEmailServiceTemplateArgs", "subject");
            }
            return $;
        }
    }
