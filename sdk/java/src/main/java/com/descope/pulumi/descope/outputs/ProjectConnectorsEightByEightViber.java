...
@CustomType
public final class ProjectConnectorsEightByEightViber {
    /**
    ...
    public static Builder builder(ProjectConnectorsEightByEightViber defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean useStaticIps;
        public Builder() {}
        public Builder(ProjectConnectorsEightByEightViber defaults) {
        ...
        public Builder apiKey(String apiKey) {
            if (apiKey == null) {
              throw new MissingRequiredPropertyException("ProjectConnectorsEightByEightViber", "apiKey");
            }
            this.apiKey = apiKey;
            return this;
        }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("ProjectConnectorsEightByEightViber", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder subAccountId(String subAccountId) {
            if (subAccountId == null) {
              throw new MissingRequiredPropertyException("ProjectConnectorsEightByEightViber", "subAccountId");
            }
        ...
        public ProjectConnectorsEightByEightViber build() {
            final var _resultValue = new ProjectConnectorsEightByEightViber();
