...
public final class ProjectConnectorsEightByEightViberArgs extends com.pulumi.resources.ResourceArgs {

    public static final ProjectConnectorsEightByEightViberArgs Empty = new ProjectConnectorsEightByEightViberArgs();
    ...
    private ProjectConnectorsEightByEightViberArgs() {}

    private ProjectConnectorsEightByEightViberArgs(ProjectConnectorsEightByEightViberArgs $) {
        this.apiKey = $.apiKey;
    ...
    public static Builder builder(ProjectConnectorsEightByEightViberArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ProjectConnectorsEightByEightViberArgs();
        }

        public Builder(ProjectConnectorsEightByEightViberArgs defaults) {
            $ = new ProjectConnectorsEightByEightViberArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ProjectConnectorsEightByEightViberArgs build() {
            if ($.apiKey == null) {
                throw new MissingRequiredPropertyException("ProjectConnectorsEightByEightViberArgs", "apiKey");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("ProjectConnectorsEightByEightViberArgs", "name");
            }
            if ($.subAccountId == null) {
                throw new MissingRequiredPropertyException("ProjectConnectorsEightByEightViberArgs", "subAccountId");
            }
            return $;
        }
    }
