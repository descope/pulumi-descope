...
class ProjectAttributesTenant(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence[builtins.str] select_options: When the attribute type is "multiselect". A list of options to choose from.
        """
        pulumi.set(__self__, "name", name)
...
class ProjectAttributesTenantAuthorization(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] view_permissions: Determines the required permissions for this tenant.
        """
...
class ProjectAttributesUserWidgetAuthorization(dict):
    ...
    def __init__(__self__, *,
                 ...
                 view_permissions: Optional[Sequence[builtins.str]] = None):
        """
        :param Sequence[builtins.str] edit_permissions: The permissions users are required to have to edit this attribute in the user management widget.
        :param Sequence[builtins.str] view_permissions: The permissions users are required to have to view this attribute in the user management widget.
        """
...
class ProjectAuthenticationEmbeddedLink(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str expiration_time: How long the embedded link remains valid before it expires.
        """
        if disabled is not None:
            pulumi.set(__self__, "disabled", disabled)
...
class ProjectAuthenticationEnchantedLink(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str expiration_time: How long the enchanted link remains valid before it expires.
...
class ProjectAuthenticationEnchantedLinkEmailService(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str connector: The name of the email connector to use for sending emails.
...
class ProjectAuthenticationEnchantedLinkEmailServiceTemplate(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: Unique name for this email template.
        :param builtins.str subject: Subject line of the email message.
        :param builtins.bool active: Whether this email template is currently active and in use.
        :param builtins.str html_body: HTML content of the email message body, required if `use_plain_text_body` isn't set.
        :param builtins.str plain_text_body: Plain text version of the email message body, required if `use_plain_text_body` is set to `true`.
        :param builtins.bool use_plain_text_body: Whether to use the plain text body instead of HTML for the email.
        """
        pulumi.set(__self__, "name", name)
...
class ProjectAuthenticationMagicLink(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str expiration_time: How long the magic link remains valid before it expires.
...
class ProjectAuthenticationMagicLinkTextService(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str connector: The name of the SMS/text connector to use for sending text messages.
...
class ProjectAuthenticationMagicLinkTextServiceTemplate(dict):
    def __init__(__self__, *,
                 ...
                 id: Optional[builtins.str] = None):
        """
        :param builtins.str body: The content of the text message.
        :param builtins.str name: Unique name for this text template.
        :param builtins.bool active: Whether this text template is currently active and in use.
        """
...
class ProjectAuthenticationOauthCustom(dict):
    ...
    def __init__(__self__, *,
                 ...
                 logo: Optional[builtins.str] = None,
                 manage_provider_tokens: Optional[builtins.bool] = None,
        ...
        :param builtins.str callback_domain: Use a custom domain in your OAuth verification screen.
        :param Mapping[str, builtins.str] claim_mapping: Maps OAuth provider claims to Descope user attributes.
        ...
        :param builtins.bool disabled: Setting this to `true` will disallow using this authentication method directly via API and SDK calls. Note that this does not affect authentication flows that are configured to use this authentication method.
        :param builtins.str issuer: The issuer identifier for the OAuth provider.
        ...
        :param builtins.bool manage_provider_tokens: Whether to enable provider token management for this OAuth provider.
        ...
        :param builtins.str redirect_url: Users will be directed to this URL after authentication. If redirect URL is specified in the SDK/API call, it will override this value.
    ...
    def manage_provider_tokens(self) -> Optional[builtins.bool]:
        """
...
class ProjectAuthenticationOtpVoiceService(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str connector: The name of the voice connector to use for making voice calls.
...
class ProjectAuthenticationOtpVoiceServiceTemplate(dict):
    def __init__(__self__, *,
                 ...
                 id: Optional[builtins.str] = None):
        """
        :param builtins.str body: The content of the voice message that will be spoken.
        :param builtins.str name: Unique name for this voice template.
        :param builtins.bool active: Whether this voice template is currently active and in use.
        """
        pulumi.set(__self__, "body", body)
        pulumi.set(__self__, "name", name)
        if active is not None:
...
class ProjectAuthenticationPassword(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.int reuse_amount: The number of previous passwords whose hashes are kept to prevent users from reusing old passwords.
...
class ProjectAuthenticationSso(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str redirect_url: The URL the end user is redirected to after a successful authentication. If one is specified in tenant level settings or SDK/API call, they will override this value.
        """
        if disabled is not None:
            pulumi.set(__self__, "disabled", disabled)
...
class ProjectConnectors(dict):
    ...
    def __init__(__self__, *,
                 ...
                 cybersixgills: Optional[Sequence['outputs.ProjectConnectorsCybersixgill']] = None,
        ...
        :param Sequence['ProjectConnectorsCybersixgillArgs'] cybersixgills: Utilize threat intelligence to block malicious login attempts or check leaks with the Cybersixgill connector.
    ...
    @property
    @pulumi.getter
    def cybersixgills(self) -> Optional[Sequence['outputs.ProjectConnectorsCybersixgill']]:
        """
...
class ProjectConnectorsAuditWebhookAuditFilter(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str key: The field name to filter on (either 'actions' or 'tenants').
        :param builtins.str operator: The filter operation to apply ('includes' or 'excludes').
        :param Sequence[builtins.str] values: The list of values to match against for the filter.
        """
...
class ProjectConnectorsAuditWebhookAuthentication(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str bearer_token: Bearer token for HTTP authentication.
        """
...
class ProjectConnectorsAuditWebhookAuthenticationApiKey(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str token: The API secret.
        """
        pulumi.set(__self__, "key", key)
...
class ProjectConnectorsAuditWebhookAuthenticationBasic(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str password: Password for basic HTTP authentication.
        :param builtins.str username: Username for basic HTTP authentication.
        """
        pulumi.set(__self__, "password", password)
...
class ProjectConnectorsAwsS3(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.bool audit_enabled: Whether to enable streaming of audit events.
        ...
        :param builtins.str auth_type: The authentication type to use.
        :param builtins.str description: A description of what your connector is used for.
        :param builtins.str external_id: The external ID to use when assuming the role.
        :param builtins.str role_arn: The Amazon Resource Name (ARN) of the role to assume.
        :param builtins.str secret_access_key: The secret AWS access key.
        :param builtins.bool troubleshoot_log_enabled: Whether to send troubleshooting events.
        """
...
@pulumi.output_type
class ProjectConnectorsCybersixgill(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "clientId":
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in ProjectConnectorsCybersixgill. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        ProjectConnectorsCybersixgill.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 ...
                 id: Optional[builtins.str] = None):
        """
        :param builtins.str client_id: API Client ID issued when you create the credentials in Cybersixgill.
        :param builtins.str client_secret: Client secret issued when you create the credentials in Cybersixgill.
        :param builtins.str name: A custom name for your connector.
        :param builtins.str description: A description of what your connector is used for.
        """
        pulumi.set(__self__, "client_id", client_id)
...
class ProjectConnectorsEightByEightViber(dict):
    ...
    def __init__(__self__, *,
                 api_key: builtins.str,
                 name: builtins.str,
                 sub_account_id: builtins.str,
                 country: Optional[builtins.str] = None,
                 description: Optional[builtins.str] = None,
                 id: Optional[builtins.str] = None,
                 use_static_ips: Optional[builtins.bool] = None):
        """
        :param builtins.str api_key: The 8x8 API key for authentication.
        :param builtins.str name: A custom name for your connector.
        :param builtins.str sub_account_id: The 8x8 sub-account ID is required for the Messaging API.
        :param builtins.str country: The country code or region where your Viber messaging service is configured.
        :param builtins.str description: A description of what your connector is used for.
    ...
    def sub_account_id(self) -> builtins.str:
        """
...
class ProjectConnectorsEightByEightWhatsapp(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str name: A custom name for your connector.
        :param builtins.str sub_account_id: The 8x8 sub-account ID is required for the Messaging API.
        :param builtins.str template_id: The ID of a WhatsApp message template.
        :param builtins.str country: The country code or region where your Viber messaging service is configured.
        :param builtins.str description: A description of what your connector is used for.
        :param builtins.bool use_static_ips: Whether the connector should send all requests from specific static IPs.
        """
...
class ProjectConnectorsElephant(dict):
    ...
    def __init__(__self__, *,
                 ...
                 id: Optional[builtins.str] = None):
        """
        :param builtins.str access_key: The Elephant access key.
        :param builtins.str name: A custom name for your connector.
        :param builtins.str description: A description of what your connector is used for.
        """
...
class ProjectConnectorsExternalTokenHttp(dict):
    ...
    def __init__(__self__, *,
                 ...
                 use_static_ips: Optional[builtins.bool] = None):
        """
        :param builtins.str endpoint: The endpoint to get the token from (Using POST method). Descope will send the user information in the body of the request, and should return a JSON response with a 'token' string field.
        :param builtins.str name: A custom name for your connector.
...
class ProjectConnectorsFirebaseAdmin(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: A custom name for your connector.
        :param builtins.str service_account: The Firebase service account JSON.
        :param builtins.str description: A description of what your connector is used for.
        """
        pulumi.set(__self__, "name", name)
...
class ProjectConnectorsForter(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str api_version: The Forter API version.
        :param builtins.str description: A description of what your connector is used for.
...
class ProjectConnectorsGenericEmailGateway(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: A custom name for your connector.
        :param builtins.str post_url: The URL of the post email request
        :param 'ProjectConnectorsGenericEmailGatewayAuthenticationArgs' authentication: Authentication Information
        :param builtins.str description: A description of what your connector is used for.
        :param Mapping[str, builtins.str] headers: The headers to send with the request
        :param builtins.str hmac_secret: HMAC is a method for message signing with a symmetrical key. This secret will be used to sign the base64 encoded payload, and the resulting signature will be sent in the `x-descope-webhook-s256` header. The receiving service should use this secret to verify the integrity and authenticity of the payload by checking the provided signature
        :param builtins.bool insecure: Will ignore certificate errors raised by the client
        :param builtins.str sender: The sender address
        :param builtins.bool use_static_ips: Whether the connector should send all requests from specific static IPs.
        """
        pulumi.set(__self__, "name", name)
...
class ProjectConnectorsGoogleMapsPlace(dict):
    ...
    def __init__(__self__, *,
                 name: builtins.str,
                 public_api_key: builtins.str,
                 address_types: Optional[builtins.str] = None,
                 description: Optional[builtins.str] = None,
                 id: Optional[builtins.str] = None,
        ...
        """
        :param builtins.str name: A custom name for your connector.
        :param builtins.str public_api_key: The Google Maps Places public API key.
        :param builtins.str address_types: The address types to return.
        :param builtins.str description: A description of what your connector is used for.
        :param builtins.str language: The language in which to return results.
        :param builtins.str region: The region code, specified as a CLDR two-character region code.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "public_api_key", public_api_key)
    ...
    def address_types(self) -> Optional[builtins.str]:
        """
...
class ProjectConnectorsRadar(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: A custom name for your connector.
        :param builtins.str public_api_key: The Radar publishable API key.
        :param builtins.str address_types: The address types to return.
        :param builtins.str description: A description of what your connector is used for.
        :param builtins.str language: The language in which to return results.
        :param builtins.float limit: The maximum number of results to return.
        :param builtins.str region: The region code, specified as a two-letter ISO 3166 code.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "public_api_key", public_api_key)
        if address_types is not None:
...
class ProjectConnectorsRecaptchaEnterprise(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.float assessment_score: When configured, the Recaptcha action will return the score without assessing the request. The score ranges between 0 and 1, where 1 is a human interaction and 0 is a bot.
        :param builtins.str base_url: Apply a custom url to the reCAPTCHA Enterprise scripts. This is useful when attempting to use reCAPTCHA globally. Defaults to https://www.google.com
        :param builtins.str description: A description of what your connector is used for.
        :param builtins.bool override_assessment: Override the default assessment model. Note: Overriding assessment is intended for automated testing and should not be utilized in production environments.
        """
        pulumi.set(__self__, "api_key", api_key)
...
class ProjectConnectorsSardine(dict):
    ...
    def __init__(__self__, *,
                 ...
                 id: Optional[builtins.str] = None):
        """
        :param builtins.str base_url: The base URL for the Sardine API, e.g.: https://api.sandbox.sardine.ai, https://api.sardine.ai, https://api.eu.sardine.ai.
        :param builtins.str client_id: The Sardine Client ID.
        :param builtins.str client_secret: The Sardine Client Secret.
        :param builtins.str name: A custom name for your connector.
        :param builtins.str description: A description of what your connector is used for.
        """
        pulumi.set(__self__, "base_url", base_url)
...
class ProjectConnectorsSeSender(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str email: The email address that will appear as the sender of the email.
        :param builtins.str name: The display name that will appear as the sender of the email.
        """
...
class ProjectConnectorsSendgridAuthentication(dict):
    ...
    def __init__(__self__, *,
                 api_key: builtins.str):
        """
        :param builtins.str api_key: SendGrid API key for authentication.
        """
        pulumi.set(__self__, "api_key", api_key)
...
class ProjectConnectorsSmtpAuthentication(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str password: Password for SMTP server authentication.
        :param builtins.str username: Username for SMTP server authentication.
        :param builtins.str method: SMTP authentication method (`plain` or `login`).
        """
        pulumi.set(__self__, "password", password)
        pulumi.set(__self__, "username", username)
...
class ProjectConnectorsSmtpServer(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str host: The hostname or IP address of the SMTP server.
        :param builtins.int port: The port number to connect to on the SMTP server.
        """
        pulumi.set(__self__, "host", host)
        if port is not None:
...
class ProjectConnectorsSupabase(dict):
    ...
    def __init__(__self__, *,
                 name: builtins.str,
                 signing_secret: builtins.str,
                 description: Optional[builtins.str] = None,
                 expiration_time: Optional[builtins.float] = None,
                 id: Optional[builtins.str] = None):
        """
        :param builtins.str name: A custom name for your connector.
        :param builtins.str signing_secret: The signing secret for your Supabase project.
        :param builtins.str description: A description of what your connector is used for.
        :param builtins.float expiration_time: The duration in minutes for which the token is valid.
        """
        pulumi.set(__self__, "name", name)
    ...
    @property
    @pulumi.getter(name="expirationTime")
    def expiration_time(self) -> Optional[builtins.float]:
        """
...
class ProjectConnectorsTurnstile(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: A custom name for your connector.
        :param builtins.str secret_key: The secret key authorizes communication between Descope backend and the Turnstile server to verify the user's response.
        :param builtins.str site_key: The site key is used to invoke Turnstile service on your site or mobile application.
        :param builtins.str description: A description of what your connector is used for.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "secret_key", secret_key)
...
class ProjectConnectorsTwilioCore(dict):
    ...
    def __init__(__self__, *,
                 ...
                 id: Optional[builtins.str] = None):
        """
        :param builtins.str account_sid: Twilio Account SID from your Twilio Console.
...
class ProjectConnectorsTwilioCoreAuthentication(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str api_key: Twilio API Key for authentication (used with API Secret).
        :param builtins.str api_secret: Twilio API Secret for authentication (used with API Key).
        :param builtins.str auth_token: Twilio Auth Token for authentication.
        """
        if api_key is not None:
            pulumi.set(__self__, "api_key", api_key)
...
class ProjectConnectorsTwilioCoreSendersSms(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str messaging_service_sid: Twilio Messaging Service SID for sending SMS messages.
        :param builtins.str phone_number: Twilio phone number for sending SMS messages.
        """
...
class ProjectConnectorsTwilioCoreSendersVoice(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str phone_number: Twilio phone number for making voice calls.
        """
        pulumi.set(__self__, "phone_number", phone_number)
...
class ProjectConnectorsTwilioVerify(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str name: A custom name for your connector.
        :param builtins.str service_sid: Twilio Verify Service SID for verification services.
        :param builtins.str description: A description of what your connector is used for.
        :param builtins.str sender: Optional sender identifier for verification messages.
        """
        pulumi.set(__self__, "account_sid", account_sid)
        pulumi.set(__self__, "authentication", authentication)
        pulumi.set(__self__, "name", name)
...
class ProjectFlows(dict):
    def __init__(__self__, *,
                 data: builtins.str):
        """
        :param builtins.str data: The JSON data defining the authentication flow configuration, including metadata, screens, contents, and references.
        """
...
class ProjectInviteSettings(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool add_magiclink_token: Whether to include a magic link token in invitation messages.
        :param builtins.str invite_url: Custom URL to include in the message sent to invited users.
        :param builtins.bool require_invitation: Whether users must be invited before they can sign up to the project.
        :param builtins.bool send_email: Whether to send invitation emails to users.
        :param builtins.bool send_text: Whether to send invitation SMS messages to users.
        """
...
class ProjectJwtTemplatesAccessKeyTemplate(dict):
    ...
    def __init__(__self__, *,
                 ...
                 auto_tenant_claim: Optional[builtins.bool] = None,
        ...
        :param builtins.str template: The JSON template defining the structure and claims of the JWT token. This is expected to be a valid JSON object given as a `string` value.
        ...
        :param builtins.bool auto_tenant_claim: When a user is associated with a single tenant, the tenant will be set as the user's active tenant, using the `dct` (Descope Current Tenant) claim in their JWT.
        :param builtins.bool conformance_issuer: Whether to use OIDC conformance for the JWT issuer field.
        ...
        :param builtins.bool enforce_issuer: Whether to enforce that the JWT issuer matches the project configuration.
        """
        pulumi.set(__self__, "name", name)
    ...
    def auto_tenant_claim(self) -> Optional[builtins.bool]:
        """
...
class ProjectProjectSettings(dict):
    ...
    def __init__(__self__, *,
                 ...
                 custom_domain: Optional[builtins.str] = None,
                 default_no_sso_apps: Optional[builtins.bool] = None,
        ...
        :param builtins.bool default_no_sso_apps: Define whether a user created with no federated apps, will have access to all apps, or will not have access to any app.
    ...
    def default_no_sso_apps(self) -> Optional[builtins.bool]:
        """
...
class ProjectProjectSettingsSessionMigration(dict):
    ...
    def __init__(__self__, *,
                 client_id: builtins.str,
                 loginid_matched_attributes: Sequence[builtins.str],
                 vendor: builtins.str,
                 audience: Optional[builtins.str] = None,
                 domain: Optional[builtins.str] = None,
                 issuer: Optional[builtins.str] = None):
        """
        :param builtins.str client_id: The unique client ID for the vendor.
        :param Sequence[builtins.str] loginid_matched_attributes: A set of attributes from the vendor's user that should be used to match with the Descope user's login ID.
        :param builtins.str vendor: The name of the vendor the sessions are migrated from, in all lowercase.
        :param builtins.str audience: The audience value if needed by the vendor.
        :param builtins.str domain: The domain value if needed by the vendor.
        :param builtins.str issuer: An issuer URL if needed by the vendor.
        """
        pulumi.set(__self__, "client_id", client_id)
    ...
    def loginid_matched_attributes(self) -> Sequence[builtins.str]:
        """
...
class ProjectStyles(dict):
    def __init__(__self__, *,
                 data: builtins.str):
        """
        :param builtins.str data: The JSON data defining the visual styling and theme configuration used for authentication, widgets, etc.
        """
        pulumi.set(__self__, "data", data)
