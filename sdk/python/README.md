...
1. Run the following command to update files to use the name of your provider (third-party: use your GitHub organization/username):
   ...
   - find and replace all instances of the boilerplate `descope` with the `NAME` of your provider.
   - find and replace all instances of the boilerplate `descope` with the `ORG` of your provider.
   - replace all instances of the `github.com/descope/pulumi-descope` repository with the `REPOSITORY` location
...
before:
  ...
  - make tfgen
builds:
- binary: pulumi-resource-descope
  dir: provider
  goarch:
  - amd64
  - arm64
  ...
  ignore: []
  ldflags:
  - -X github.com/descope/pulumi-descope/provider/pkg/version.Version={{.Tag}}
  main: ./cmd/pulumi-resource-descope/
  sort: asc
  use: git
release:
  disable: false
...
├── config.yaml
├── metadata.json
├── pulumi-descope_darwin_amd64_v1
│   └── pulumi-resource-descope
├── pulumi-descope_darwin_arm64
│   └── pulumi-resource-descope
├── pulumi-descope_linux_amd64_v1
│   └── pulumi-resource-descope
├── pulumi-descope_linux_arm64
│   └── pulumi-resource-descope
├── pulumi-descope_windows_amd64_v1
│   └── pulumi-resource-descope.exe
└── pulumi-descope_windows_arm64
    └── pulumi-resource-descope.exe
```
